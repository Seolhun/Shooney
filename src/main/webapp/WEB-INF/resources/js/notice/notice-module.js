...
var NoticeService = (function () {
    var noticeUpdateForm = function (noticeId) {
        ...
        $('#noticeContentUpdate').summernote("code", $('#noticeContent' + noticeId).html());
    ...
    var noticeUpdate = function () {
        ...
        noticeId = $('#noticeIdUpdate').val();
        noticeUri = $('#noticeUriUpdate').val();
        noticeContent = $('#noticeContentUpdate').val();
        noticeState = $('#noticeStateUpdate').val();
