...
public class ExceptionHandlingController {
	...
	@ExceptionHandler({MultipartException.class, FileUploadOverException.class, FileUploadOverException.class})
	public ModelAndView handleMultipartException(HttpServletRequest req, MultipartException multipartException){
		LOG.error("Request: " + req.getRequestURL() + " raised " + multipartException);
		ModelAndView mav = new ModelAndView();
		mav.addObject("multipartException", multipartException);
		mav.addObject("url", req.getRequestURL());
		mav.setViewName("error");
		return mav;
	}
