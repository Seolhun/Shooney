...
//			model.addAttribute("fileBucket", fileData);
//			return "singleFileUploader";
//		}
//
//		@RequestMapping(value = "/singleUpload", method = RequestMethod.POST)
//		public String singleFileUpload(@Valid FileData fileData, BindingResult result, ModelMap model, MultipartRequest mpr) throws IOException {
//			if (result.hasErrors()) {
//				logger.info("validation errors");
//				return "singleFileUploader";
//			} else {
//				System.out.println("Fetching file");
//				MultipartFile multipartFile = mpr.getFiles(UPLOAD_LOCATION);
//
//				// Now do something with file...
//				FileCopyUtils.copy(fileData.getFile().getBytes(),
//						new File(UPLOAD_LOCATION + fileData.getFile().getOriginalFilename()));
